...
namespace Point_and_Rectangle
{
    public partial class Form1 : Form
    {
            ...
            decimal x1, decimal y1, decimal x2, decimal y2, decimal x, decimal y)
        {
            ...
            {
                this.textBoxResult.Text = "Inside";
                this.textBoxResult.BackColor = Color.Green;
            }

            else if (x < left || x > right || y < bottom || y > top)
            {
                this.textBoxResult.Text = "Outside";
                this.textBoxResult.BackColor = Color.Red;
            }
            else
            {
                this.textBoxResult.Text = "Border";
                this.textBoxResult.BackColor = Color.Blue;
            }
